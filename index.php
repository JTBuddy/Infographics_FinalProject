    ...
    <div class="jumbotron jumbotron-fluid">
        ...
        <div class="container" id="mainContainer">
                ...
                <div class="row" id="section2">
                  ...
                  <div>
                    <p>With the explosive popularity with social media apps like Facebook, Instagram and Twitter I believe that this one of the main catalysts of the rapid growth of mobile phone usage.</p>
                  </div>
                  
                  <!-- Android vs iPhone from Google Trends -->
                  <!-- iPhone -->
